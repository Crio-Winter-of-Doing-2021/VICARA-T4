...
export const sideNav = [
  ...
  {
    name: "Favourites",
    routerPath: "/favourites",
    icon: <StarRoundedIcon />,
  },
  {
    name: "Shared with Me",
    routerPath: "/shared-with-me",
...
export const steps = [
  {
    ...
    content: () => (
      <div>
        <div
          style={{ marginTop: "15px", textAlign: "center", fontSize: "15px" }}
        >
          Welcome to Vicara T4, go ahead and check all the functionalities we
          have to offer!
        </div>
      </div>
    ),
    ...
    content: () => (
      <div>
        <div
          style={{ marginTop: "15px", textAlign: "center", fontSize: "15px" }}
        >
          Mark your favourite files, change their accessibility and mark them to
          perform many more activities!
        </div>
        <div
          style={{
            display: "flex",
    ...
    content: () => (
      <div>
        <div
          style={{ marginTop: "15px", textAlign: "center", fontSize: "15px" }}
        >
          Right Click on a row to open a lot more functionalites for that
          particular file and folder.
        </div>
        <div
          style={{
            display: "flex",
    ...
    content: () => (
      <div>
        <div
          style={{ marginTop: "15px", textAlign: "center", fontSize: "15px" }}
        >
          Files/Folders shared with you will be displayed here. Below you can
          see how you can share!
        </div>
        <div
          style={{
            display: "flex",
    ...
    content: () => (
      <div>
        <div
          style={{ marginTop: "15px", textAlign: "center", fontSize: "15px" }}
        >
          You can also sort files either alphabetically or when they were
          last_accessed.
        </div>
        <div
          style={{
