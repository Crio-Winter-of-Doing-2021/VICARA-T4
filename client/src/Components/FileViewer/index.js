...
import {ViewModalState,toggleModal,fileData} from '../../store/slices/fileViewSlice'
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <div style={{width:"65vw",height:"80vh",display:"flex",justifyContent:"center",alignItems:"center"}}>
            {fileRenderer()}
          </div>
        </DialogContent>
        <DialogActions>
