  ...
  return (
    <div>
      <ListItemText
        ...
        onClick={() => {
          handleClickOpen();
          dispatch(fileAsync(file_id));
          dispatch(pathAsync(file_id));
          dispatch(userAsync());
        }}
      >
        Share
      ...
      >
        ...
        <List>
          ...
          {/* <Divider light/> */}
          <ListItem>
            <Typography className={classes.heading}>Favourite</Typography>
            <Typography className={classes.secondaryHeading}>
        ...
        <List>
          <ListItem>
            ...
            <Typography className={classes.secondaryHeading}>{path}</Typography>
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            <Typography className={classes.heading}>Sharing Link</Typography>
            <Typography
              style={{ display: "flex" }}
              className={classes.secondaryHeading}
            >
