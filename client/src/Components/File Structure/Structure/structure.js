...
import {structureAsync,selectStructure,changeKey,currentStructure} from '../../../store/slices/structureSlice'
            ...
            <StyledTableRow key={data.key}>
                <StyledTableCell component="th" scope="row">
                    <div style={{display:'flex',alignItems:"center"}}>
                        {data.type==='FOLDER'?<FolderOpenTwoToneIcon/>:<DescriptionTwoToneIcon/>}
                        <Link
                            component="button"
                            variant="body2"
