...
import {selectFolderView,getFolderPickerView,pathAsync,selectParent} from '../../../store/slices/moveSlice'
...
function FolderList() {
    ...
    return (
        <>
            {resultRenderer.length!==0?resultRenderer:<div style={{width:"100%",display:"flex",justifyContent:"center"}}>
                  <Typography style={{color:"grey",marginTop:"20px"}}>Move your selected files/folders in {parent_name}</Typography>
              </div>}
        </>
    )
}
