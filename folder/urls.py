from .views import Filesystem, UploadFolder, DownloadFolder, FolderPicker, ParitalDownload
...
urlpatterns = [
    ...
    path('partial-download/',  ParitalDownload.as_view(), name="partial-download"),
